...
export const ui = {
  ...
  ameriqualMilitary: {
    ...
    metaDescription: loc(
      ...
      "Business Link fornisce razioni militari, umanitarie e di emergenza di AmeriQual Foods — MRE, HDR, First Strike, Heat & Serve e A-Rations — per la distribuzione internazionale.",
    ),
    ...
    heroDescription: loc(
      ...
      "Attraverso AmeriQual Group, LLC, Business Link può fornire razioni individuali e di gruppo concepite per le forze armate statunitensi e alleate, e per programmi umanitari e di soccorso in caso di disastro.",
    ),
    supportsTitle: loc(
    ...
    supportsBody: loc(
      ...
      "AmeriQual progetta, sviluppa e consegna razioni individuali e di gruppo alle forze militari in tutto il mondo. In qualità di fornitore di riferimento delle forze armate statunitensi, produce alimenti operativi di alta qualità da oltre 30 anni e fornisce anche razioni umanitarie e di soccorso in caso di disastro per governi e ONG. Business Link rappresenta AmeriQual come distributore master ed esportatore.",
    ),
    sealsAlt: loc(
      "U.S. Air Force, Army, Coast Guard, Navy and Marine Corps seals",
      "Sellos de la Fuerza Aérea, el Ejército, la Guardia Costiera, la Armada y el Cuerpo de Marines de EE. UU.",
    ...
    certificationsLabel: loc("Quality certifications", "Certificaciones de calidad", "Certificazioni di qualità"),
    certificationsBody: loc(
      ...
      "La produzione di AmeriQual Foods è supportata dai marchi di qualità SQF / HACCP, FDA, USDA, USDA Organic e GMA utilizzati nei loro programmi militari.",
    ),
    ...
    inquire: loc("Inquire about military rations", "Consultar raciones militares", "Informazioni sulle razioni militari"),
    ...
    bannerBody: loc(
      ...
      "MRE, HDR, First Strike, Heat & Serve e A-Rations di AmeriQual Foods — più kit di emergenza auto-riscaldanti per l'alimentazione istituzionale.",
    ),
